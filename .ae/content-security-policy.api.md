...
// @public (undocumented)
export const cspDirectives: ({ directives, patterns }: Options) => Promise<string[]>;

// @public (undocumented)
export const cspHeader: ({ directives, patterns }: Options) => Promise<string>;

// @public (undocumented)
export const cspObj: ({ directives, patterns }: Options) => Promise<{}>;

// Warning: (ae-missing-release-tag) "deprecated_directive" is part of the package's API, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
export const deprecated_directive: z.ZodUnion<[z.ZodLiteral<"block-all-mixed-content">, z.ZodLiteral<"plugin-types">, z.ZodLiteral<"prefetch-src">, z.ZodLiteral<"referrer">, z.ZodLiteral<"report-uri">, z.ZodLiteral<"require-sri-for">]>;

// Warning: (ae-missing-release-tag) "DeprecatedDirective" is part of the package's API, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
